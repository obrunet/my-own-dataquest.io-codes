...
taxi_modified[:,0] = 16
taxi_modified[[1800,1801],7]=numpy.mean(taxi[:,7],axis=0)
...
mean_distance = numpy.mean(cleaned_taxi[:,7])
mean_length = numpy.mean(cleaned_taxi[:,8])
mean_total_amount = numpy.mean(cleaned_taxi[:,13])
mean_mph = numpy.mean(trip_mph[trip_mph<100])