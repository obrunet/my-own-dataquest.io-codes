...
# list should contain the name of the app, the rating count, and the user rating.
...
print(len(apps_data), apps_data[0], apps_data[1:3])
...
all_ratings = []
for row in apps_data[1:]: # exclude header row
