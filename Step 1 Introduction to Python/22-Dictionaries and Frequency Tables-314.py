...
for row in apps_data[1:]:
    genre = row[11]    
    if genre not in genre_counting:
...
# transform the frequencies to percentages
for var in content_ratings:
    content_ratings[var] /= total_number_of_apps
    content_ratings[var] *= 100
...
content_ratings = {'4+': 4433, '12+': 1155, '9+': 987, '17+': 622}
total_number_of_apps = 7197
c_ratings_proportions, c_ratings_percentages = {}, {}
